...
- auth service: DONE — GitHub OAuth + email/password, session-based, in-memory userStore (see 02)
- frontend onboarding: DONE — 5-step flow (auth → profile → experience → github-repos → template picker)
